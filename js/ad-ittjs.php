...
jQuery(window).load(function() {
	...
	<?php if (get_option('top_ad_link') != "" && get_option('top_ad_img') != "") {
			echo("jQuery(\"body\").prepend(\"<a id='top_ad' href='".get_option('top_ad_link')."'><img src='".get_option('top_ad_img')."' /></a>\");");
	} ?>
	<?php if (get_option('bottom_ad_link') != "" && get_option('bottom_ad_img') != "") {
		echo("jQuery(\"body\").append(\"<a id='bottom_ad' href='".get_option('bottom_ad_link')."'><img src='".get_option('bottom_ad_img')."' /></a>\");");
	} ?>
	<?php if (get_option('left_ad_link') != "" && get_option('bottom_ad_img') != "") {
		echo("jQuery(\"body\").append(\"<a id='left_ad' href='".get_option('left_ad_link')."'><img src='".get_option('left_ad_img')."' /></a>\");");
	} ?>
	<?php if (get_option('right_ad_link') != "" && get_option('right_ad_img') != "") {
		echo("jQuery(\"body\").append(\"<a id='right_ad' href='".get_option('right_ad_link')."'><img src='".get_option('right_ad_img')."' /></a>\");");
	} ?>
